...
${OBJECTDIR}/ButtonReactionFactory.o: ButtonReactionFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ButtonReactionFactory.o ButtonReactionFactory.cpp

${OBJECTDIR}/ConfigManager.o: ConfigManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ConfigManager.o ConfigManager.cpp
...
${OBJECTDIR}/GameScene.o: GameScene.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GameScene.o GameScene.cpp
